...
export const metadata: Metadata = {
  title: 'Contact Us | iGreen Systems',
  description: 'Get in touch with iGreen Systems for IoT solutions, digital transformation projects, and technology consulting.',
};
...
export default function ContactPage() {
  return (
    <div style={{ backgroundColor: '#0A0F1C', color: '#F9FAFB' }}>
      {/* Header */}
      <section className="py-20 text-center" style={{ backgroundColor: '#060A12' }}>
            ...
            {offices.map((o) => (
              ...
              >
                ...
                {o.phones.map((p) => (
                  ...
                  >
                    <span className="w-3.5 h-3.5" style={{ color: '#5CB85C' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-5">
              ...
              <a
                ...
                className="flex items-center gap-3 p-4 rounded-xl border transition-colors hover:border-opacity-60"
                style={{ backgroundColor: '#111827', borderColor: '#1F2937' }}
              >
              ...
              >
                ...
                <p className="text-sm text-gray-400">
                  We respond to all inquiries within <span style={{ color: '#5CB85C' }}>1 business day</span>.
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border text-white placeholder-gray-600 outline-none focus:border-opacity-80 transition-colors"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border text-white placeholder-gray-600 outline-none transition-colors"
                      style={{ backgroundColor: '#111827', borderColor: '#1F2937', color: '#F9FAFB' }}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border text-white placeholder-gray-600 outline-none transition-colors resize-none"
                    style={{ backgroundColor: '#111827', borderColor: '#1F2937', color: '#F9FAFB' }}
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto px-10 py-3.5 rounded-xl text-base font-semibold text-white transition-all hover:opacity-90"
