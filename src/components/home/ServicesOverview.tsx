...
const iotServices = [
  {
    ...
    label: 'IoT Solutions',
    desc: 'End-to-end IoT architecture, sensor integration, and real-time data pipelines.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Intelligent device ecosystems — hardware selection, firmware, and cloud connectivity.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: 'Industry 4.0 intelligence — real-time monitoring, predictive maintenance, OEE optimization.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: 'Strategy to execution — process digitization, legacy modernization, change management.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const deliveryServices = [
  {
    ...
    desc: 'Scalable web apps with React, Next.js, and cloud-native architectures.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
